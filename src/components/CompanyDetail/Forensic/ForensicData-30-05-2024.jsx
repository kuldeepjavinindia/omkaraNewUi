          ...
          // if (i != 1 && typeData == "CF" || typeData != "CF") {
            ...
            return (
              ...
              {/* <div style={{ display: !checked && i == 2 && typeData == "CF" ? 'none': 'unset' }} ></div> */}
                <div className={`mb-3 ${(!checked && i == 2 && typeData == "CF") ? "hidden" : "block"}`}>
  {/* {
   typeData === "CAP" ? (
    ...
    "No CAP"
               ...
               >
                <div>
              <table className=  " w-full h-full overflow-scroll border-[1px] border-[#E5E5E5] rounded bg-clip-border ">
                <thead>
                    <tr>
                        {
                          mColArr.map((column, clm) => {
                            ...
                            return (
                              <th key={clm} className="border-b border-blue-gray-100 bg-[#1E233A] text-white p-2 text-[13px] lg:text-[15px] font-medium text-left px-4">{column.label}</th>
                            )
                          })
                        }
                ...
                <tbody>
                  {
                    allRowsData.map((row, is) => {
                      ...
                      return (
                        ...
                        <tr className="odd:bg-[#E8F0F4] even:bg-[#fff]" key={is}>
                          {
                            ...
                            var cStyle = {};
                              ...
                              return (
                                <td key={c1} style={cStyle} className="text-[#000] text-[13px] lg:text-[15px] px-4 py-1 relative">
{
                                            value === " "
                                              ?
                                              <>
...
<Tooltip  className = "text-[11px]" content= {filterTooltip(value)} >
      <svg
        ...
        stroke="currentColor"
        strokeWidth={2}
        className="relative inline-block top-0  h-5 w-5 cursor-pointer text-blue-gray-500"
      >
        <path
          strokeLinecap="round"
...

{
      typeData == "CF" && i == 0 
        ?
                   <>
                 <Checkbox checked={checked} onChange={showHide} name="gilad" label={`${ !checked ? "Show" : "Hide" }  Detailed Data`} />
                   </>
                   : null
 }
...

{
                                highlights && highlights.length > 0 && highlights.map((highlight, i00) => {
                                  ...
                                  return (
                                    <div className="bg-[#fff] text-center rounded pt-3" key={i00}
                                    // sx={{
