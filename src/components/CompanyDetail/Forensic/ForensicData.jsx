                    ...
                    <tr>
                        {
                          mColArr.map((column, clm) => {
                            ...
                            return (
                              <th className="border-b border-blue-gray-100 bg-[#1E233A] text-white p-2 text-[13px] lg:text-[15px] font-medium text-left px-4">{column.label}</th>
                            )
                          })
                        }
                        ...
                        <tr className="odd:bg-[#E8F0F4] even:bg-[#fff]">
                          {
                            ...
                            var cStyle = {};
                              ...
                              return (
                                <td  style={cStyle} className="text-[#000] text-[13px] lg:text-[15px] px-4 py-1 relative">
...

{
                                highlights && highlights.length > 0 && highlights.map((highlight, i00) => {
                                  ...
                                  return (
                                    <div className="bg-[#fff] text-center rounded pt-3" 
                                    sx={{
...
{/* ========== Start Comment Box============ */}
 ...
 />
<div className="flex justify-between bg-[#fff] pt-4 pl-4 pb-7 pr-4 mt-3 rounded">
