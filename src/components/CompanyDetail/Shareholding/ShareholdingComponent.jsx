...
const ShareholdingComponent = () => {
  ...
  const {
    ...
    SCShareHolding: { data: ShareHoldingData, loading: ShareHoldingLoading },
          ...
          <thead>
            <tr className={`!bg-[#22242F]`}>
              {TableColumns.map((item, i) => {
                ...
                return (
                  <th
                    className={`!text-white p-2 text-[13px] font-semibold !bg-[#22242F]"`}
                    style={cStyle}
                    key={i}
                  >
                    {item.label}
                    ...
                    {TableColumns.map((item, i) => {
                      ...
                      return (
                        <td
                          style={cStyle}
                          key={i}
                          className={`text-[13px] px-2 font-medium `}
                        >
                          <div
                            style={{
                              display: "flex",
                                ...
                                >
                                  <img
                                    src={
                                      ...
                                      "/images/icons/resultChartIcon.svg"
                                    }
                                    alt=""
                                    className="w-[20px]"
                                  />
