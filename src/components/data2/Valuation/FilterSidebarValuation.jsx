...
<label className="text-[12px] text-[#000] font-medium">Away 52wk High (%)</label>
        <Input
            type="text"
            name="TTM"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Away 52wk Low (%)
</label>
        <Input
            type="text"
            name="rice"
...
<label className="text-[12px] text-[#000] font-medium">All Time High (%)
</label>
        <Input
            type="text"
            name="TTM Sale"
...
<label className="text-[12px] text-[#000] font-medium">TTM PE (x)
</label>
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">TTM PBV (x)
...
<Input
      ...
      {/* End Card Form */}
       ...
       <Accordion open={ActiveAccordion.accordion_3}  className="rounded bg-[#fff] px-2 py-3 mt-2" icon={<Icon id={3} open={ActiveAccordion.accordion_3} />}>
        ...
        <Typography className="text-[15px] text-[#000] font-semibold w-[90%]">Historical</Typography>
        
        </AccordionHeader>
        <AccordionBody>
        <label className="text-[12px] text-[#000] font-medium">Diff B/w 5yrs Avg P/BV(x)</label>
        <Input
            type="text"
            name="sale yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
        ...
        <label className="text-[12px] text-[#000] font-medium">Diff B/w 10yrs Avg P/BV(x)</label>
        <Input
            type="text"
            name="sale QOQ"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Diff B/w 5yrs Avg P/E(x)</label>
        <Input
            type="text"
...
<label className="text-[12px] text-[#000] font-medium">Diff B/w 10yrs Avg P/E(x)</label>
        <Input
            type="text"
...
<label className="text-[12px] text-[#000] font-medium">Avg. Sales 3yrs (cr.)</label>
        <Input
            type="text"
            name="ebdita yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Avg. Sales 5yrs (cr.)</label>
        <Input
            type="text"
            name="ebdita QOQ"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Avg. Sales 10yrs (cr.)</label>
        <Input
            type="text"
            name="pat yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Avg. PAT 3yrs (cr.)</label>
        <Input
            type="text"
            name="pat QOQ"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Avg. PAT 10yrs (cr.)
</label>
        <Input
            type="text"
            name="pat QOQ"
...
<label className="text-[12px] text-[#000] font-medium">Gross Profit (Cr.)</label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
            type="text"
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit 3yrs (cr.)
        </label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit 5yrs (cr.)
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit 10yrs (cr.)
</label>
<div className="flex gap-2">
<div className="min-w[48%] w-[48%]">
<Input
...
<label className="text-[12px] text-[#000] font-medium">Gross Profit Margin(%)
...
<label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit Margin(%) 3yrs</label>
<div className="flex gap-2">
<div className="min-w[48%] w-[48%]">
<Input
    type="text"
...
<label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit Margin(%) 5yrs
</label>
<div className="flex gap-2">
<div className="min-w[48%] w-[48%]">
<Input
...
<label className="text-[12px] text-[#000] font-medium">Avg. Gross Profit Margin(%) 10yrs
...
{/* End Two input in row */}
      ...
      {/* End Card Form */}
         ...
         {/* Start Card Form */}
         <Accordion open={ActiveAccordion.accordion_4}  className="rounded bg-[#fff] px-2 py-3 mt-2" icon={<Icon id={4} open={ActiveAccordion.accordion_6} />}>
        <AccordionHeader onClick={() => handleOpen(4)} className="flex border-none py-0 pt-0">
        <Typography className="text-[15px] text-[#000] font-semibold w-[90%]">Balance Sheet</Typography>
        
        </AccordionHeader>
        <AccordionBody>
           
        <label className="text-[12px] text-[#000] font-medium">Total Debt/ Equity (x)</label>
        <Input
            type="text"
            name="sale yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Gross Block Addition in 5yrs(Cr.)</label>
        <Input
            type="text"
            name="sale yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<label className="text-[12px] text-[#000] font-medium">Total Debt Increase in 5yrs(Cr.)</label>
        <Input
            type="text"
            name="sale yoy"
            className=" !border !border-[#C7C7C7]  !bg-[#fff] text-gray-900 ring-4 ring-transparent placeholder:text-gray-500 placeholder:opacity-100"
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. ROCE (%) 3yrs        </label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
            type="text"
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. ROCE (%) 5yrs        </label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
            type="text"
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Avg. ROCE (%) 10yrs        </label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
            type="text"
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Net Cash/(Net Debt) (cr.)
        </label>
        <div className="flex gap-2">
        <div className="min-w[48%] w-[48%]">
        <Input
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">Net Cash/ Mcap (x)
...
<Input
        ...
        <label className="text-[12px] text-[#000] font-medium">CFO/EBIDTA (x)
...
{/* End Two input in row */}
      ...
      {/* End Card Form */}
        ...
        <Typography className="text-[15px] text-[#000] font-semibold w-[90%]">Share Holding Pattern</Typography>
        
        </AccordionHeader>
        <AccordionBody>
        <label className="text-[12px] text-[#000] font-medium">Promoter Holding (%)
        </label>
        <Input
            type="text"
            name="ebidta margin"
...
<label className="text-[12px] text-[#000] font-medium">Pledge (%)
</label>
        <Input
            type="text"
            name="sale QOQ"
