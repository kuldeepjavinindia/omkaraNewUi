  ...
  <table className="forensicTable w-[40%] border border-collapse border-[#B3B3B3] h-full">
    ...
    <tbody>
      <tr className="odd:bg-[#E8F0F4] even:bg-[#fff] h-10">
        ...
        <td className="sticky sticky left-[133px] bg-[#E8F0F4] text-[12px] xl:text-[13px] text-[#000] font-semibold text-left">Agri</td>
        <td className="sticky  left-[192px] border-r border-[#B3B3B3]  bg-[#E8F0F4] text-[12px] xl:text-[13px] text-[#000] font-semibold text-left">10204</td>
       
      </tr>
      <tr className="odd:bg-[#E8F0F4] even:bg-[#fff] h-10">
        <td className="sticky left-0 bg-[#fff] text-[12px] xl:text-[13px] text-[#000] font-semibold text-left">Bharat Dynamics Ltd.</td>
        <td className="sticky sticky left-[133px] bg-[#fff] text-[12px] xl:text-[13px] text-[#000] font-semibold text-left">Agri</td>
        <td className="sticky  left-[192px] border-r border-[#B3B3B3]  bg-[#fff] text-[12px] xl:text-[13px] text-[#000] font-semibold text-left">10204</td>
    ...
    <tfoot>
   <tr>
   <td className="text-white  text-[12px] xl:text-[13px] font-semibold bg-[#1E233A] text-left">COMPANY NAME</td>
    <td className="text-white  text-[12px] xl:text-[13px] font-semibold bg-[#1E233A] text-left">SECTOR</td>
    <td className="text-white  text-[12px] xl:text-[13px] font-semibold bg-[#1E233A] text-left">INDUSTRY</td>
   </tr>
    </tfoot>
