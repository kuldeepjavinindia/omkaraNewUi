...
const FilterSidebarDeliveryData = () => {
  ...
  return (
    <>
      <div className="filterSidebar w-full rounded py-2 px-2 bg-[#E9EDEF] col-span-3 h-screen overflow-y-scroll relative">
        ...
        <div className="">
          ...
          >
            ...
            >
              ...
              <Typography className="text-[13px] text-[#FF2026] font-semibold">
                RESET
              </Typography>
            </AccordionHeader>
            <AccordionBody>
              <div className="flex justify-between">
                ...
                <Typography className="text-[#7B70FF] text-[12px] font-semibold">
                  Refresh
                </Typography>
              </div>
              <Select
          ...
          >
            ...
            <AccordionBody>
              <div className="flex flex-col gap-2">
                <div>
                  <Radio name="type" label="Weekly" className="block" />
                  <Radio name="type" label="Monthly" className="block" />
                  <Radio name="type" label="Half Yearly" className="block" />
                </div>

                <div>
                  <Radio name="type" label="15 Days" className="block" />
                  <Radio name="type" label="Quarterly" className="block" />
                  <Radio name="type" label="Yearly" className="block" />
                </div>
              </div>
            </AccordionBody>
          </Accordion>
